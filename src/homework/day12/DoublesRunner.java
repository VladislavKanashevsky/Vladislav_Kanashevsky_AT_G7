...
public class DoublesRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(doubles.map(s -> (int) Math.round(s)).map(random::nextInt).distinct().map(s -> {
                ...
                .mapToInt(s -> s.peek(System.out::println).mapToInt(Bubble::getVolume).sum()).sum());
